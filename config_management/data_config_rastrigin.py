class DataConfig:
    data_file_path = "./data/rastrigin.csv"
    processed_data_prefix = "rastrigin"
    columns = ['# x1', 'x2']
    ...
    # b_adj_c = 1.0
    bw_adj_joint_range = (0.25, 1.25) # Range for bandwidth adjustment for joint distribution KDE
