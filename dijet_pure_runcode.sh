#!/bin/bash
#SBATCH --job-name=dijet_pur                        # Job name
...
#SBATCH --output=logs/slurm-%j-%N_dijet_pur.out     # the print of xxx.jl will be logged in this file, %N for node name, %j for job id:w

module load StdEnv/2023 julia/1.11.3
julia --thread=64 sdes_pipeline.jl "dijet_neural" "config_dijet_pureloss" "false"
