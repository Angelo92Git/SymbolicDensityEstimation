#!/bin/bash
#SBATCH --job-name=gcls1                         # Job name
...
#SBATCH --output=logs/slurm-%j-%N_gcls1.out      # the print of xxx.jl will be logged in this file, %N for node name, %j for job id:w

module load StdEnv/2023 julia/1.11.3
julia --thread=64 sdes_pipeline.jl "gaussian_cluster_1" "config_gaussian" "false"
