#!/bin/bash
#SBATCH --job-name=gcls2                         # Job name
...
#SBATCH --output=logs/slurm-%j-%N_gcls2.out      # the print of xxx.jl will be logged in this file, %N for node name, %j for job id:w

module load StdEnv/2023 julia/1.11.3
julia --thread=64 sdes_pipeline.jl "gaussian_cluster_2" "config_gaussian" "false"
