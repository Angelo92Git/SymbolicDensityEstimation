#!/bin/bash
#SBATCH --job-name=gis12                         # Job name
...
#SBATCH --output=logs/slurm-%j-%N_gis12.out      # the print of xxx.jl will be logged in this file, %N for node name, %j for job id:w

module load StdEnv/2023 julia/1.11.3
julia --thread=64 sdes_pipeline.jl "gaussian_independent_set12" "config_gaussian" "false"
