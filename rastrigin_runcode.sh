...
#SBATCH --output=logs/slurm-%j-%N_ras.out      # the print of xxx.jl will be logged in this file, %N for node name, %j for job id:w

module load StdEnv/2023 julia/1.11.3
julia --thread=64 sdes_pipeline.jl "rastrigin" "config_rastrigin" "false"
